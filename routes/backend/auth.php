...
use App\Domains\Auth\Http\Controllers\Backend\Product\ProductController;
...
Route::group([
    ...
    Route::group([
        ...
        Route::group([
            ...
            //  Route::post('team/store',[TeamController::class,'store'])->name('tink');    
    ...
    Route::group([
        ...
        // Route::get('product/show',[TeamController::class,'show'])->name('show');    
...
Route::group([
    ...
    Route::get('team/edit/{id}',[TeamController::class,'edit'])->name('edit');  
    Route::patch('team/update',[TeamController::class,'update'])->name('tupdate');
    Route::delete('team/delete/{id}', [TeamController::class, 'destroy'])->name('remove');  
});